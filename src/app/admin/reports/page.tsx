  ...
  const fetchReportData = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_ANALYTICS_API_URL || 'https://vehicle-dealership-analytics.nick-damato0011527.workers.dev'}/api/reports?type=${reportType}&range=${dateRange}`
      );
